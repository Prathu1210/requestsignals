              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <div style={{ 
                  ...
                  <p style={{ 
                    ...
                    <strong>RequestSignals provides information based on publicly available data.</strong> We aggregate and curate service requests from public platforms like LinkedIn. We do not guarantee the accuracy, completeness, or availability of any information displayed on our platform.
                  </p>
                  <div style={{ 
                ...
                <div style={{ 
                  ...
                  <p style={{ 
                    ...
                    <strong>RequestSignals is not affiliated with LinkedIn or any third-party platforms referenced.</strong> We are an independent service that aggregates publicly available information.
                  </p>
                  ...
                  <div style={{ 
                    ...
                    <p style={{ 
                      ...
                      When you click on links to LinkedIn or other platforms, you leave RequestSignals and are subject to those platforms' terms and privacy policies. We have no control over and assume no responsibility for the content, privacy policies, or practices of any third-party sites or services.
                    </p>
                  </div>
                </div>
